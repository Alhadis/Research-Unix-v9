...
char *av[];
{
	...
	if (d.dialtype==NULL || *d.dialtype=='\0')
		d.dialtype = "D1200";
	if (equal(d.dialtype, "300"))
		d.dialtype = "D300";
	else if (equal(d.dialtype, "1200"))
		d.dialtype = "D1200";
	else if (equal(d.dialtype, "D"))
		d.dialtype = "D1200";
	else if (equal(d.dialtype, "C"))
		d.dialtype = "C1200";
	if (nflag) {
