 ...
 *
 * $Log:	include.c,v $
 * Revision 1.3  87/08/14  18:14:41  toddb
 * Add the routine inc_clean().  This will "un-mark" all nodes after traversal,
 * so that during traversal, no node is printed more than once.
 * 
