/* $Header: Xresource.h,v 1.1 87/09/11 08:09:41 toddb Exp $ */
/*
 *	sccsid:	%W%	%G%
 */
...
extern void XrmSetCurrentDataBase(); /* db */
    /* XrmResourceDataBase db; */

extern void XrmGetCurrentDataBase(); /* db */
    /* XrmResourceDataBase *db;    /* RETURN */

extern void XrmGetDataBase(); /* magicCookie, db*/
    /* unspecified      magicCookie; /*  *FILE, actually */
    /* XrmResourceDataBase *db;	     /*  RETURN		 */

extern void XrmPutDataBase(); /* magicCookie, db */
    /* unspecified magicCookie;     /*  *FILE, actually */
    /* XrmResourceDataBase db;				*/
...
typedef struct {
    ...
    caddr_t     value;		/* Value to provide if XrmoptionStickyArg    */
