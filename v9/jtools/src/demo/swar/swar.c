...
main(argc,argv){
	...
	stardwg=ToBitmap((char *)starbits, 4, 0, 0, 16, 16);
	p0dwg=ToBitmap((char *)p0bits, 8, 0, 0, 44, 44);
	p1dwg=ToBitmap((char *)p1bits, 8, 0, 0, 44, 44);
	misdwg=ToBitmap((char *)misbits, 4, 0, 0, 32, 32);
	boomdwg=ToBitmap((char *)boombits, 8, 0, 0, 64, 64);
