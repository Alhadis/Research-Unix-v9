...
*/
extern short Bits24[], Bits40[];
Bitmap Bitmap24;
Bitmap Bitmap40;

main(argc,argv)
{
	request(KBD|ALARM|MOUSE);
	mousemotion();
	initdisplay(argc,argv);
	Bitmap24 = ToBitmap(Bits24,30, 0,0,240,24);
	Bitmap40 = ToBitmap(Bits40,130, 0,0,1040,40);
	init();
	Running = TRUE;
	Freeze = FALSE;
	retxy(1);
...
instruct()
{
	...
	mvprintf(13,10,"use mouse to move");
	mvprintf(14,10,"<f> to freeze game.");

	mvprintf(15,10,"<q> to quit.");
	mvprintf(16,10,"<n> to start a new game.");
	mvprintf(17,10,"<s> to toggle sound.");
	mvprintf(19,10,"Select game 1, 2, 3, or 4.");
	/*cursallow();*/
}
/*
