...
/*
 *	the emulex sc750 massbus controller refers to hpcc as hphr
 *	(holding register), and uses it to divine the size of the
 *	disk connected to the controller
 */
#define hphr hpcc
#define	HPHR_MAXCYL	0x8017
#define	HPHR_MAXTRK	0x8018
#define HPHR_MAXSECT	0x8019
