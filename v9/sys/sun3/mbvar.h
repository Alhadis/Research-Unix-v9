...
struct mb_driver {
	...
	short	mdr_flags;		/* want exclusive use of Mainbus */
	struct	mb_driver *mdr_link;	/* interrupt routine linked list */
};

/* Driver flags */
#define MDR_XCLU	01		/* needs exclusive use of bus */
#define MDR_BIODMA	02		/* block device does Mainbus DMA */
#define MDR_SWAB	04		/* Mainbus buffer must be swabbed */
