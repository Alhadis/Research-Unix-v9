#ifndef lint
static	char sccsid[] = "@(#)tm.c	1.1 86/02/03	Copyr 1985 Sun Micro";
#endif
	...
	register struct saioreq *sip;
{
...

	{
		...
		/* Give back the dma space this screwy Intel device needs */
		setpgmap((char *)tmscp, virtstart);
